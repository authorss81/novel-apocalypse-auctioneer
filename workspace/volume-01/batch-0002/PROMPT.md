# Volume 01 Batch 0002 Writing Prompt — The First Hammer, Chapters 11–20
...
`reviews/batch-0001-review.md` is optional background. Read it only if you want to know which approved card beats the finished prose declined or which findings the pipeline owner still has open; it is audit history, and nothing in it is required to write Chapter 11.
...
- **Four places, four names — do not blur them.** The *loading spur* is the near-side track behind the old school shelter up to the Ward Nine old platform and its bell post; the charter calls that same track the *marked spur*. The *maintenance spur* is a different place: the false destination the bent route delivered the bus to in Chapter 6. The *service approach* is Selik's official bridge, which carries the supervised small-cargo exception used in Chapter 6. The old shelter by the platform was emptied into the east ward, so it has rails and a canopy and people waiting when a bus is due, but no children and no cots. The nine children named as beneficiaries were **housed before crossing** in the old gym on the near bank; eight of them crossed in Chapter 9 and one stayed behind. The stranded bus the token came from is a **near-side** wreck, out past the underpass. Chapter 9 fixes the round trip in concrete terms: the bus crosses to a receiving ramp on the far side, and it comes home to the old platform beside the depot, where Mara counts the toll "so the yard could hear it." Keep the return on the Lot 17 apron.
...
- Sixteen people paid the toll on that crossing, and one of the nine children named as beneficiaries refused to board. Tarin can still drive the marked route and cannot say why he carried the medicine. Dessa can still name Ward Nine and cannot say why she went. Eight children, two escort stewards, and four of the five medicine crew are on the far bank, one of those four being Renn Fisk, the crew's porter and responsible party for the boxes; the stewards accepted duty for nine and answer for the eight that went, and the boy who refused is on this side. **The count is fixed and audited: 8 + 2 + 4 far bank, plus Tarin and Dessa who returned, equals the sixteen in the public book.** Do not add a seventeenth person to the far bank. A relief driver off the St. Orra staging line was also offered a place and gave it back; that is a second refusal, not a seventeenth traveler.
- **Renn Fisk is the clinic porter of Chapters 1–6, not a new man.** He is the unnamed porter who sets the six-hour coolant clock in Chapter 1, calls it down in Chapter 5, boards the failed activation, and is winched out of the flooded service wall in Chapter 6, where Mara's affected list names him. Chapter 9 identifies him on the page as that same porter crossing a second time, knowing what the first one cost. The reader has watched him go once and come back, so the Chapter 16 return is his second informed crossing. Do not write a second porter, and do not write him as though the far bank were the first time he had seen the route.
- **Every charter and book entry carries the bank's name.** "Ward Nine" is a far-bank district and a near-bank platform, so the return is always written as the old Ward Nine platform on this side of the water or on the near apron, and the beneficiaries as the Ward Nine clinic line on the far bank. Both forms are now used in the Chapter 9 spoken terms and the Chapter 10 book. A bare "the Ward Nine platform" reintroduces the collision this batch already had to fix.
- The two medicine boxes that crossed in the failed Chapter 5 activation were recovered and brought **back across the official bridge** over the supervised cargo exception, so nothing had reached the clinic before the Chapter 9 crossing. All six cold boxes were on the Lot 17 side when Chapter 9 opened. Do not retroactively put delivered medicine in the Chapter 6 timeline.
...
- The public lot board is a constituted four-seat panel: the registrar, the sitting steward, and two rotating seats held by whoever in the yard has no claim on the lot. It can refuse to record a closing and call a review. It cannot grant a use. Lot 17 has a public lot book, a seven-day steward term held by Nessa Pell, a sealed-page rule for responsible parties who must be identified, a protected-name rule for households, and a public appeal path. **Note what the board has and has not actually done:** during the Chapter 9 closing it was Mara who recorded personally, and the panel only seats and acts for the first time in Chapter 10, when it appoints Nessa in an audible vote. Do not retroactively give the panel a refusal or a review it never made — if this batch needs the board to act, show the members in the room when they act.
- **Two sealed sheets, not one.** The two escort stewards' names are on a sheet Mara sealed and holds *and* on a second sheet the school keeps, each marked rather than signed, so the stewards hold their own record of the duty. Both are canon.
- Adrian Vale is Stage 1 Reader. He can read use, immediate toll, and standing on one contacted lot, but contact costs him a toll echo: exhaustion, metallic taste, sensory distortion, hand weakness, or memory gaps. He cannot predict, read continuously, transfer or renew a charter, split a use among bearers, or post security. He is not a Binder. He has lost no memories as a traveler; the echo is a reading cost, and the Chapter 6 gaps came from the bare-claimant toll he paid as default bearer without ever boarding. One unexplained exception, not a rule: in Chapter 6 he also briefly received a fragment of *Tarin's* memory of purpose and noticed it was not his. It happened once, was never explained, and must not be used as a mechanic. If it returns, escalate it as a mystery.
- **Adrian's private engine, stated in Chapter 1.** He was twenty-one on the Alder Reach platform when the north stair went, and his own clean handwriting got eleven people off and left four behind. He has spent seventeen years pricing the difference. That is the root of his compulsion, and Chapters 18–19 are where it costs him something he cannot price. Iven Tallow gave him the blank lot before the Fracture; Chapter 2 has him set the blank lot against the token on the strength of an old instruction and get nothing.
...
Do not make every chapter an auction, a fight, or a System notice. Use recovery, work, argument, paperwork, and personal consequence between action beats. Let the public process be shown through documents, rooms, refusals, and consequences rather than a lecture.
...
**Emotional/practical consequence:** Mara acts before she has certainty and becomes responsible for the consequence. She publicly disagrees with Selik without pretending his safety history is worthless.

**Ending:** Selik accepts the review's written question but not Mara's preferred remedy. Adrian must decide whether to use the official bridge's delay or press the public route again.
...
**Major turn:** Orren finds that the counterfeit is being distributed through several apparently separate brokers using the same copied form. The mark is not merely a signature; it is being used to make a document look like it belongs to a shared closing system.

**Emotional consequence:** Orren chooses to preserve the dangerous evidence and keep the household location out of the public record, but he does not become obedient. He insists on a copy in the kitchen exchange and a public challenge path.

**Ending:** A courier reports that a private carrier has already accepted Halloway's claim and intends to cross before dawn. Adrian must prepare a public process before fear makes the counterfeit easier to believe.
...
**Major turn:** Lina and Mara agree on a limited protected category: the public book records a group, count, steward, destination, and remedy, while a paper witness network can confirm who has chosen to participate without publishing a household. The rule is not a loophole; a person who refuses a name still receives care and still can challenge the closing.

**Emotional consequence:** Lina stops treating Adrian as someone who will inevitably file her and begins treating Mara's process as a tool that must answer to people, not only to clerks.

**Ending:** The public board receives its first challenge from a household that refuses to be named but accepts the route. The challenge is valid, forcing the next crossing to name a remedy before it opens.
...
**Major turn:** Tarin teaches Adrian that standing is a relationship between a person, a route, and a return point, not a property of the token. Adrian pays for the axle repair with labor rather than hiding the cost. Tarin agrees to consider another public charter only if the return condition is read before anyone boards.

**Emotional consequence:** Adrian's desire to lead is redirected toward preparation and disclosure. He accepts that Tarin's refusal can be a form of safety.

**Ending:** A second route card shows a maintenance cut that the official map omitted. The next crossing may need a different return marker, and the Hearth Line cannot be a single fixed route forever.
...
**Emotional consequence:** Adrian's want expands from protecting Lot 17 to holding a region together, while his fear of another evacuation makes him eager to control the room.

**Ending:** Halloway tells Adrian privately that the public board will be sold to the people who can afford certainty. Adrian does not have a rebuttal yet.
...
**Emotional consequence:** Adrian tells himself that the private promise is temporary and that the public process will catch the error. He has learned the shape of the mistake but not yet its cost.

**Ending:** The auction sheet is completed and copied. The public board reads complete except for a return condition Adrian has privately promised to write later. The first convoy arrives at the staging line before dawn.
...
**Major turn:** Adrian and Mara conduct a public auction for one defined use, not ownership and not a permanent route. Adrian discloses the outward memory toll and the fact that the return may cost again, but frames the return as part of the same administrative term rather than a separately negotiable toll. Halloway's counterfeit is publicly exposed when a carrier refuses its labor clause. The public crowd still accepts Adrian's terms because the immediate need is real and Adrian's private guarantee makes the sale feel safe.
...
**Major turn:** Adrian reads the term back from his own handwriting and finds that the return was folded inside the administrative term, exactly where he put it. He said out loud that the return would cost again, and he never said what that cost was or who would be asked to pay it separately — which is the breach, not a silence. He still does not know where the bus is. He has to decide whether to extend the route for another load, reprice it, or open a public question while people are still outside and the document that admitted them contains no return term of its own. He chooses to open the question, and finds that admitting the gap in public costs him the sale he just made. Do not show the false destination or the full backwash here; that is Chapters 23–26.

**Emotional consequence:** The relief of the outward crossing curdles into dread. Adrian's first instinct is to extend or reprice the route; Mara forces him to say what is known and unknown before acting.

**Ending:** The return bus is not at the marked platform. A public complaint is already being written, and the next medicine case is due before anyone has agreed how to describe what happened. The batch ends with a visible missing return, not a manufactured cliffhanger.
...
- The return memory toll must remain real. Do not erase it, make it a joke, or let a price line cancel it. It was paid by sixteen people on the first crossing, including the eight children who remain on the far bank, and it must be accounted for in full whenever a crossing is recorded — a crossing's number of travelers is whatever the record says boarded, not whatever the charter hoped for. Check the arithmetic before you write a count: name every person by side, and make the spoken total match the book.
- Keep the four place-names apart: loading spur and marked spur are the same near-side track, the maintenance spur is the false destination, and the service approach is Selik's bridge. Chapter 11 onward depends on the return landing beside Lot 17, not at Ward Nine.
...
- The public board has four seats and no owner. It can refuse to record a closing and call a review. It cannot grant a use, and it must not be written as a body the reader has never seen seated. It was also never the recorder of the Chapter 9 closing — Mara was. If it acts in this batch, put its members in the room.
...
After the batch, inspect `outline/volume-01.md`. Chapters 21–50 remain, so create exactly one next-phase directory under `workspace/volume-01/` and write its detailed `PROMPT.md` for Chapters 21–30. Do not create a later phase, a volume-close prompt, or a second batch prompt.
