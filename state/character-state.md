# Character State — After Chapter 0020

## The public lot board

Four seats and no owner: Mara Quill as registrar, the sitting steward, and two rotating places held by whoever in the yard has no claim on the lot. It can refuse to record a closing, publish a result, call a review, uphold a challenge in part, and set or renew a short public custody term. It cannot grant a use, cannot waive a toll, and does not vote on whether people should be brave. **Any chapter that gives the board authority must name all four seats aloud and put them in the room before it acts.** Seats used in Batch 0002: Coll Ferrin (tram driver) and Marda Osk (tea seller at the tram arch) in Chapters 11 and 16; Ilma Trent (tram conductor) and Bevon Rahl (cooper) in Chapter 19.

## Adrian Vale

- **Age/role:** 38; independent auctioneer at Lot 17; **Stage 1 Reader, and still not a Binder.**
- **Physical state:** Every real reading costs a toll echo: exhaustion, a metallic taste, flattened sound, and a right hand that stays slightly open. He can still inspect, write, and negotiate; he cannot read continuously. He lost an afternoon in Chapter 17 to a third consecutive reading, and the public book records it. The echo is the price of reading; the memory toll belongs to people who knowingly travel. **He has never been a traveler.** The one unexplained exception — the fragment of Tarin's memory of purpose in Chapter 6 — has not recurred and must not be used as a mechanic if it does.
...
- **Age/role:** 34; municipal registrar and author of the public lot book, the proposal schedule, and the no-name remedy.
...
- **Current state:** proved the counterfeit is a printing plate rather than four forgers, and proved the broken circle is a claim about a system by finding it on a Warden fuel return, a school ration ledger and a pre-Fracture salt permit. He cut his mother's margin note off the evidence along the sheet's crease and gave it to Bett Ruhl so no household could be found on the same page, and he has not told anybody that he chose that. He printed eleven third pages overnight and put one in front of Sabin Tull at half past four in the morning.
- **What he refused to do:** publish everything at once, burn the evidence, or let the household location into a public record. He keeps the mark on the bundle and the name on a scrap of paper under a flour barrel.
- **His warning that mattered:** *say what it costs and who pays it separately, or you have not written a term* — given in Chapter 17, after Adrian had already promised to do it. He is not a safe apprentice, and he does not trust the process; he trusts a page.
- **Sela Pike:** the erasure record is now separated from the evidence and in someone else's keeping, and he has said nothing about that to Mara or to Adrian.

## Lina Vale

- **Age/role:** 27; Unlisted memory courier and organizer; Adrian's younger sister.
- **Current state:** stopped expecting to be filed. She said so in front of eleven people at the kitchen exchange, said that she wants Adrian in the room and would rather he were not needed, and said both out loud so that it would stop being the kind of thing she only thinks.
- **What she and Mara agreed:** the book carries a group, a count, a steward, a destination and a remedy; a paper note of who chose to take part is held outside the book by people the household chooses; a person who refuses a name still gets water, shelter and medicine and still has the right to stop a closing.
- **Current want:** keep her community safe from records that have already harmed it, without turning refusal into a way of being helpless.
- **Relationship with Adrian:** no longer a future problem to be managed. Not a solution either.
- **Relationship with Mara:** she now treats Mara's process as a tool that has to answer to people and not only to clerks, which is a harder standard than Mara is currently meeting.

## Selik Marne

- **Age/role:** Civic Warden and administrator of the official St. Orra crossing.
- **Current state:** more credible than at the start of the batch and not defeated. A gauge fault and a correct full-deck evacuation cost a woman with a feverish child her provisional berth, and Selik says so in his own words in the record. The housing is rebuilt and certified by two people outside his administration. The manifest is tightened: responsible party at the abutment, a second adult name for any child, the certified housing before any passenger crossing, halved slots. The review continues on the ninth. He accepted the review's written question and refused Mara's group designation and her sealable page, on the stated ground that a registrar's private page on a working span is a single point of failure dressed as protection.
- **What he did for the public route:** posted a Warden and a white flag on the marked spur for every minute of the term, and stopped short of the river wall when the search party wanted to go further. He offered four cargo boxes a day and the named work crew, and refused the eleven children without a roll.
- **His line in the yard:** a rule that cannot be read aloud by the people it governs has already failed the people it governs; a return term with no person in it is a confidence, and he will not stand a flag on a confidence. He also said, in front of two hundred people, that Adrian is the only person in Alder Reach regulated by a promise he wrote himself, and that this is not a compliment.
- **Next volume's work for him:** Chapters 27–33. He uses the Chapter 19 failure to argue for a permanent Warden route. He must be argued with, not defeated, and his safety record must stay real.
...
- **Roles:** the two fresh independent witnesses for the first public charter. Neither travelled, and that is why the appeal path still has its pair. They have not witnessed since; the Chapter 16 pair was Coll Ferrin and Marda Osk, and the Chapter 19 pair was Ilma Trent and Bevon Rahl.
- **Function:** the pair kept its memory by staying, which is the whole mechanism the batch's remedy depends on.
- **Open thread:** Alma is the steward of a school shelter that now houses two unnamed people, one of them a five-year-old with a fever; she lodged the question that Mara could not answer, which is how a remedy is supposed to work for a person the record cannot point at.
...
- **Role:** laundress, mother of Tam Keel, who was one of the eight on the far bank.
- **What she did:** argued in the kitchen exchange for having her name written down, because she was tired of a good argument about handles that had not once got her son home. Then she volunteered as the named remembering passenger for the Chapter 16 return and said the reason out loud in the yard once — *I am going because my boy is on the other bank and I sent him there* — on the understanding that it would not be written down. She asked to be told the place and not the why, and understood what that meant.
- **Her son is home. She is not the same person who asked for him.** Nobody on the near bank has yet established what she lost, and that is an open account.

## Nell Sarr, Nessa Pell, and the Road House

- **Nell Sarr:** the young Warden who carries Selik's voice, opened the gauge housing, identified the bent float, and stood a white flag on the marked spur for every minute of the Chapter 19 term. She stopped the search party at the river wall.
- **Nessa Pell:** Lot 17 clerk and sitting steward. Her seven-day term has been renewed twice in public and has two days left. She read the toll aloud in the travelers' own words in Chapters 16 and 19, read Rell Bode's challenge aloud in Chapter 14, read the RETURN field aloud in Chapter 20, and told Adrian in Chapter 16 that the repair nights would be recorded in the book before the crossing rather than after.
- **The Road House:** Tarin's operation. It holds the wheel man who could not be trusted to sit at home and wait, and the second axle, and Bryn, and forty hours of shop time that Adrian has already paid in labor.

## Sela Pike

Orren's mother remains an unresolved erased name. **The margin note carrying her name has been physically separated from the counterfeit evidence and is under a flour barrel in Bett Ruhl's kitchen exchange, and Orren has told nobody that he did it.** A name can be evidence without being a restoration, and preserving it by removing it from the only public thing he has is a move with a cost he has not yet paid.

## Iven Tallow

Iven remains presumed dead from Adrian's point of view. He is not present, alive, or identified as the source of the broken-circle mark. Chapters 23–26 are where Mara will say aloud that Adrian is making the same emergency exception Iven made and calling it temporary; that accusation is moral and professional, and it proves nothing about Iven.

## The two people who are not in this book yet

**Petra Sill and Bel.** A guardian and a five-year-old with a fever, turned back off the official span in the Chapter 12 evacuation, and housed by the school shelter with no names written. They are the standing proof that Selik's manifest requirement has a body attached to it, and they are why the shelter's count has grown.
